        ...
        <div style={{
            ...
            <div className="native-card" style={{ width: '100%', maxWidth: '600px', margin: 0, animation: 'scaleIn 0.3s cubic-bezier(0.34, 1.56, 0.64, 1)', padding: '30px', borderRadius: '20px', boxShadow: '0 20px 50px rgba(0,0,0,0.3)', maxHeight: '90vh', overflowY: 'auto' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '25px' }}>
                    <h2 style={{ margin: 0, color: '#00a63a', fontSize: '1.6rem', fontWeight: '900' }}>{editingId ? 'Editar Funcionário' : 'Novo Funcionário'}</h2>
                </div>
                ...
                <form onSubmit={onSave} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                    ...
                    <div>
                        <h3 style={{ fontSize: '1rem', color: '#333', marginBottom: '15px', display: 'flex', alignItems: 'center', gap: '8px' }}>
                            <Shield size={18} color="#00a63a" /> Permissões de Acesso
                        </h3>
                            ...
                            <div style={{ display: 'flex', background: '#e9ecef', padding: '4px', borderRadius: '8px' }}>
                                <button
                                    ...
                                    style={{
                                        ...
                                        color: !formData.permissions?.canEdit ? '#00a63a' : '#666',
                        ...
                        <div>
                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '15px' }}>
                                ...
                                <button type="button" onClick={toggleAllRoutes} style={{ border: 'none', background: 'transparent', color: '#00a63a', fontWeight: 'bold', fontSize: '0.8rem', cursor: 'pointer' }}>
                                    Selecionar Todas
                                </button>
                            </div>
                                            ...
                                            {category.routes.map(item => {
                                                ...
                                                return (
                                                    <div
                                                        ...
                                                        style={{
                                                            padding: '10px', borderRadius: '8px', border: isSelected ? '1px solid #00a63a' : '1px solid #ddd',
                                                            background: isSelected ? '#eef8ff' : '#fff', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '10px',
                                                            transition: 'all 0.2s',
                                                    ...
                                                    >
                                                        <div style={{
                                                            ...
                                                            background: isSelected ? '#00a63a' : 'transparent', display: 'flex', alignItems: 'center', justifyContent: 'center',
                                                            flexShrink: 0
                                                        }}>
                                                            {isSelected && <Check size={12} color="#fff" strokeWidth={3} />}
                                                        </div>
                                                        <span style={{ fontSize: '0.85rem', color: isSelected ? '#00a63a' : '#555', fontWeight: isSelected ? '700' : '500', lineHeight: 1.2 }}>{item.label}</span>
                                                    </div>
                                                );
                                            })}
                                        </div>
